...
//               sh """#!/bin/bash
//               source ./script/aerospike_delete_node.sh
//               stop_container_and_delete_node \$(echo "${nodeip}") \$(echo "${ec2_node_name}")
//               """
//           }
//         }
//       }
...
//               sh """#!/bin/bash
//               source ./script/aerospike_delete_node.sh
//               delete_dns_record_update_inventory_file \$(echo "${nodeip}") \$(echo "${ec2_node_name}")
//               """
//           }
//         }
//       }
...
//                 git commit -m "Deleted Node with jenkins build # ${currentBuild.number} aerospike node DNS ${ec2_node_name}"
